...
def mod_6():
  ...
  conv4_ = layers.Conv2D(600, 3, activation='relu', padding='same')(pool6)
  conv4 = layers.Conv2D(600, 3, activation='relu', padding='same')(conv4_)
  ...
  dconv6 = layers.Conv2DTranspose(400, 3, strides=2, activation='relu', padding='same')(conv4)
  ...
  dense3 = layers.Dense(30, activation='relu')(dense3)
