...
def mod_6_skip():
  ...
  conv12 = layers.Conv2D(450, 3, activation='relu', padding='same')(pool5)
  conv12 = layers.Conv2D(450, 3, activation='relu', padding='same')(conv12)
  pool6 = layers.MaxPool2D(2)(conv12)

  conv4_ = layers.Conv2D(650, 3, activation='relu', padding='same')(pool6)
  conv4 = layers.Conv2D(650, 3, activation='relu', padding='same')(conv4_)
  ...
  dconv6 = layers.Conv2DTranspose(450, 3, strides=2, activation='relu', padding='same')(conv4)
  conc6 = layers.concatenate([dconv6, conv12])
  conv13 = layers.Conv2D(450, 3, activation='relu', padding='same')(conc6)
  conv13 = layers.Conv2D(450, 3, activation='relu', padding='same')(conv13)
  ...
  dense2 = layers.Dense(20, activation='relu')(conc_d1)
  ...
  dense3 = layers.Dense(15, activation='relu')(conc_d2)
