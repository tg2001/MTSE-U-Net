...
def mod_7_skip():
  ...
  conv12 = layers.Conv2D(400, 3, activation='relu', padding='same')(pool5)
  conv12 = layers.Conv2D(400, 3, activation='relu', padding='same')(conv12)
  pool6 = layers.MaxPool2D(2)(conv12)

  conv14 = layers.Conv2D(600, 3, activation='relu', padding='same')(pool6)
  conv14 = layers.Conv2D(600, 3, activation='relu', padding='same')(conv14)
  pool7 = layers.MaxPool2D(2)(conv14)

  conv4_ = layers.Conv2D(800, 3, activation='relu', padding='same')(pool7)
  conv4 = layers.Conv2D(800, 3, activation='relu', padding='same')(conv4_)
  ...
  dconv7 = layers.Conv2DTranspose(600, 3, strides=2, activation='relu', padding='same')(conv4)
  conc7 = layers.concatenate([dconv7, conv14])
  conv15 = layers.Conv2D(600, 3, activation='relu', padding='same')(conc7)
  conv15 = layers.Conv2D(600, 3, activation='relu', padding='same')(conv15)

  dconv6 = layers.Conv2DTranspose(400, 3, strides=2, activation='relu', padding='same')(conv15)
  conc6 = layers.concatenate([dconv6, conv12])
  conv13 = layers.Conv2D(400, 3, activation='relu', padding='same')(conc6)
  conv13 = layers.Conv2D(400, 3, activation='relu', padding='same')(conv13)

  dconv5 = layers.Conv2DTranspose(256, 3, strides=2, activation='relu', padding='same')(conv13)
  ...
  dense2 = layers.Dense(30, activation='relu')(conc_d1)
  outp2 = layers.Dense(3, name='output2', activation='sigmoid')(dense2)

  dense3 = layers.Dense(40, activation='relu')(dense1)
  dense3 = layers.Dense(40, activation='relu')(dense3)
  conc_d2 = layers.concatenate([dense1, dense3])
  dense3 = layers.Dense(10, activation='relu')(conc_d2)
